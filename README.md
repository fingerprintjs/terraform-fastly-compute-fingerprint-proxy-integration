...
| `agent_script_download_path`         | Path to serve agent script from your domain (only when supporting JS Agent v3)                                                                                                                 | Optional | `"4fs80xgx"`                                            |
| `get_result_path`                    | Path to serve identification and browser cache requests (only when supporting JS Agent v3)                                                                                                     | Optional | `"vpyr9bev"`                                            |
...
| `kv_store_enabled`                   | **Deprecated**: Use `kv_store_save_sealed_result_plugin_enabled` and `kv_store_save_event_plugin_enabled` instead. Enable KV store integration                                                 | Optional | `false`                                                 |
| `kv_store_save_sealed_result_plugin_enabled` | Enables plugin to save sealed result to KV store                                                                                                                                       | Optional | `null`                                                  |
| `kv_store_save_event_plugin_enabled` | Enables plugin to save events to KV store                                                                                                                                                      | Optional | `"false"`                                               |
| `kv_store_save_plugin_enabled`       | **Deprecated**: Use `kv_store_save_sealed_result_plugin_enabled` instead. Enables plugin to save sealed result to KV store                                                                     | Optional | `"false"`                                               |
| `kv_store_prefix`                    | **Deprecated**: Prefix for the sealed result KV store name. Will be hardcoded in a future version                                                                                              | Optional | `"Fingerprint_Results_"`                                |
| `region`                             | Region for the Fingerprint API. One of: `us`, `eu`, `ap`. When set, a single `fingerprint` backend is created. When null, legacy regional backends are used (deprecated)                       | Optional | `"eu"`                                                  |
